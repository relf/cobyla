...
pub type cobyla_calcfc = unsafe extern "C" fn(
    libc::c_long,
    libc::c_long,
    *const libc::c_double,
    *mut libc::c_double,
...
pub unsafe extern "C" fn raw_cobyla(
    ...
    let mut a: *mut libc::c_double = datmat
...
#[no_mangle]
pub unsafe extern "C" fn cobyla_create(
    mut n: libc::c_long,
    mut m: libc::c_long,
    mut rhobeg: libc::c_double,
    mut rhoend: libc::c_double,
    ...
    if n < 1 as libc::c_int as libc::c_long || m < 0 as libc::c_int as libc::c_long
        || rhobeg < rhoend || rhoend <= 0 as libc::c_int as libc::c_double
    ...
    offset2 = (::std::mem::size_of::<libc::c_double>() as libc::c_ulong)
        ...
        as libc::c_long;
    size = (offset2 as libc::c_ulong)
        .wrapping_add(
            ((n
                * (3 as libc::c_int as libc::c_long * n
    ...
    memset(ctx as *mut libc::c_void, 0 as libc::c_int, size as libc::c_ulong);
    (*ctx).n = n;
    (*ctx).m = m;
    ...
    *fresh5 = ((*ctx).datmat).offset((n * mpp) as isize).offset(mpp as isize);
...
#[no_mangle]
pub unsafe extern "C" fn cobyla_delete(mut ctx: *mut cobyla_context_t) {
    if !ctx.is_null() {
        free(ctx as *mut libc::c_void);
    }
}
#[no_mangle]
pub unsafe extern "C" fn cobyla_restart(mut ctx: *mut cobyla_context_t) -> libc::c_int {
    if ctx.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn cobyla_get_status(
    mut ctx: *const cobyla_context_t,
) -> libc::c_int {
    if ctx.is_null() {
        *__errno_location() = 14 as libc::c_int;
        return -(3 as libc::c_int);
...
#[no_mangle]
pub unsafe extern "C" fn cobyla_get_nevals(
    mut ctx: *const cobyla_context_t,
) -> libc::c_long {
    if ctx.is_null() {
        *__errno_location() = 14 as libc::c_int;
...
#[no_mangle]
pub unsafe extern "C" fn cobyla_get_rho(
    mut ctx: *const cobyla_context_t,
) -> libc::c_double {
    if ctx.is_null() {
        *__errno_location() = 14 as libc::c_int;
...
#[no_mangle]
pub unsafe extern "C" fn cobyla_get_last_f(
    mut ctx: *const cobyla_context_t,
) -> libc::c_double {
    if ctx.is_null() {
        *__errno_location() = 14 as libc::c_int;
...
#[no_mangle]
pub unsafe extern "C" fn cobyla_iterate(
    ...
    if nfvals == 0 as libc::c_int as libc::c_long {
        ...
        while i <= n {
            ...
            *sim
                .offset(
                    (i - 1 as libc::c_int as libc::c_long
                        + n * (i - 1 as libc::c_int as libc::c_long)) as isize,
                ) = rho;
            *simi
                .offset(
                    (i - 1 as libc::c_int as libc::c_long
        ...
        match current_block {
            14453151562619017203 => {
                    ...
                    && iprint > 0 as libc::c_int as libc::c_long
                {
                    ...
                    fprintf(
                        stderr,
                        b"Return from subroutine COBYLA because %s.\n\0" as *const u8
            ...
            _ => {
                    ...
                    || iprint == 3 as libc::c_int as libc::c_long
                {
                    print_calcfc(
                        ...
                        f,
                        resmax,
                        &mut *x.offset((1 as libc::c_int - 1 as libc::c_int) as isize)
                            as *mut libc::c_double as *const libc::c_double,
                    );
                }
                ...
                if ibrnch == 1 as libc::c_int as libc::c_long {
                    ...
                    if jdrop == 0 as libc::c_int as libc::c_long {
                        ...
                        while i <= n {
                            *sim
                                .offset(
                                    (i - 1 as libc::c_int as libc::c_long
                                        + n * (jdrop - 1 as libc::c_int as libc::c_long)) as isize,
                                ) = *dx
                                .offset((i - 1 as libc::c_int as libc::c_long) as isize);
                            temp
                                += *simi
                        ...
                        while k <= mpp {
                            *datmat
                                .offset(
                                    (k - 1 as libc::c_int as libc::c_long
                                        + mpp * (jdrop - 1 as libc::c_int as libc::c_long)) as isize,
                                ) = *con
                    ...
                    if !(nfvals > np) {
                                ...
                                *sim
                                ...
                                while k <= jdrop {
                                    ...
                                    *sim
                                        .offset(
                                            (jdrop - 1 as libc::c_int as libc::c_long
                                                + n * (k - 1 as libc::c_int as libc::c_long)) as isize,
                                        ) = -rho;
                                    i = k;
                                    while i <= jdrop {
                                        temp
                        ...
                        if nfvals <= n {
                            jdrop = nfvals;
                            *x
                                .offset((jdrop - 1 as libc::c_int as libc::c_long) as isize)
                                += rho;
                            current_block = 14453151562619017203;
                            continue;
                        }
                                    ...
                                    while k <= mp {
                                        ...
                                        while i <= n {
                                            temp = *datmat
                                                .offset(
                                                    (k - 1 as libc::c_int as libc::c_long
                                                        + mpp * (i - 1 as libc::c_int as libc::c_long)) as isize,
                                                );
                        ...
                        _ => {
                            ...
                            while j <= n {
                                temp = *datmat
                                    .offset(
                                        (mp - 1 as libc::c_int as libc::c_long
                                            + mpp * (j - 1 as libc::c_int as libc::c_long)) as isize,
                                    )
                                    + parmu
                                        * *datmat
                                            .offset(
                                ...
                                if temp < phimin {
                                    ...
                                    if *datmat
                                        ...
                                        < *datmat
                                            .offset(
                                                (mpp - 1 as libc::c_int as libc::c_long
                                                    + mpp * (nbest - 1 as libc::c_int as libc::c_long)) as isize,
                                            )
                                    {
                                        nbest = j;
                                    }
                            ...
                            if nbest <= n {
                                ...
                                while i <= n {
                                    temp = *sim
                                        .offset(
                                            (i - 1 as libc::c_int as libc::c_long
                                                + n * (nbest - 1 as libc::c_int as libc::c_long)) as isize,
                                        );
                                    *sim
                                        .offset(
                                            (i - 1 as libc::c_int as libc::c_long
                            ...
                            if error > 0.1f64 {
                                    ...
                                    || iflag == 1 as libc::c_int as libc::c_long
                                {
                                    ...
                                    let mut zdota: *mut libc::c_double = z
                                        .offset((n * n) as isize);
                                    let mut vmc: *mut libc::c_double = zdota.offset(n as isize);
                                    let mut sdirn: *mut libc::c_double = vmc
                                        .offset(mp as isize);
                                    let mut dxnew: *mut libc::c_double = sdirn
                                        .offset(n as isize);
                                    ...
                                    *con
                                        .offset(
                                            (mp - 1 as libc::c_int as libc::c_long) as isize,
                                        ) = zero;
                                    sum = zero;
                                    k = 1 as libc::c_int as libc::c_long;
                                    while k <= mp {
    ...
    'c_3166: loop {
            ...
            && iprint > 0 as libc::c_int as libc::c_long
        {
            ...
            f = calcfc
                ...
                )(n, m, x as *const libc::c_double, con, calcfc_data);
            nfvals += 1;
            resmax = zero;
            k = 0 as libc::c_int as libc::c_long;
            while k < m {
            ...
            *con.offset((mpp - 1 as libc::c_int as libc::c_long) as isize) = resmax;
            if ibrnch == 1 as libc::c_int as libc::c_long {
                ...
                j = 1 as libc::c_int as libc::c_long;
                while j <= n {
                    if *sigbar.offset((j - 1 as libc::c_int as libc::c_long) as isize)
                        >= parsig
                        || *sigbar
                            .offset((j - 1 as libc::c_int as libc::c_long) as isize)
                            >= *vsig
    ...
    'c_5472: loop {
        match current_block {
            16746262731645592041 => {
                ...
                *vmultc
                    .offset((mcon - 1 as libc::c_int as libc::c_long) as isize) = zero;
                current_block = 10785318058620693244;
            }
            _ => {
                optold = zero;
                ...
                loop {
                            ...
                            optnew
                                -= *dx
                                    ...
                                    * *a
                                        .offset(
                                            (i - 1 as libc::c_int as libc::c_long
                                                + n * (mcon - 1 as libc::c_int as libc::c_long)) as isize,
                                        );
                            i += 1;
                        }
                    }
                    ...
                    if icon <= nact {
                                    ...
                                    sp
                                        += *z
                                            ...
                                            * *a
                                                .offset(
                                                    (i - 1 as libc::c_int as libc::c_long
                                                        + n * (kk - 1 as libc::c_int as libc::c_long)) as isize,
                                                );
                                    i += 1;
                                }
                                temp = sqrt(
                                ...
                                while i <= n {
                                    temp = alpha
                                        * *z
                                            .offset(
                                                (i - 1 as libc::c_int as libc::c_long
                                                    + n * (kp - 1 as libc::c_int as libc::c_long)) as isize,
                                            )
                                        + beta
                                            * *z
                                                .offset(
                                    ...
                                    += *sdirn
                                        ...
                                        * *z
                                            .offset(
                                                (i - 1 as libc::c_int as libc::c_long
                                                    + n
                                                        * (nact + 1 as libc::c_int as libc::c_long
                        ...
                        while k > nact {
                            ...
                            acca = spabs + Op1 * fabs(sp);
                            accb = spabs + Op2 * fabs(sp);
                        ...
                        if tot != zero {
                            ...
                            *vmultc
                                .offset(
                                    (icon - 1 as libc::c_int as libc::c_long) as isize,
                                ) = *vmultc
                            ...
                            *vmultc
                            ...
                            loop {
                                ...
                                acca = zdvabs + Op1 * fabs(zdotv);
                                accb = zdvabs + Op2 * fabs(zdotv);
                                            ...
                                            *dxnew
                                                ...
                                                -= temp
                                                    * *a
                                                        .offset(
                                                            (i - 1 as libc::c_int as libc::c_long
                                                                + n * (kw - 1 as libc::c_int as libc::c_long)) as isize,
                                                        );
                                            i += 1;
                                        }
                                    }
                            ...
                            while i <= n {
                                temp
                                    += *z
                                        .offset(
                                            (i - 1 as libc::c_int as libc::c_long
                                                + n * (nact - 1 as libc::c_int as libc::c_long)) as isize,
                                        )
                                        * *a
                                            .offset(
                                                (i - 1 as libc::c_int as libc::c_long
                    ...
                    if mcon == m {
                        ...
                        while k <= nact {
                            kk = *iact
                                .offset((k - 1 as libc::c_int as libc::c_long) as isize);
                            temp = *b
                                .offset((kk - 1 as libc::c_int as libc::c_long) as isize);
                            i = 1 as libc::c_int as libc::c_long;
                            while i <= n {
                                temp
                                    -= *a
                    ...
                    loop {
                        ...
                        acca = zdwabs + Op1 * fabs(zdotw);
                        accb = zdwabs + Op2 * fabs(zdotw);
                    ...
                    if mcon > nact {
                        ...
                        while k <= mcon {
                            ...
                            acca = sumabs + Op1 * fabs(sum);
                            accb = sumabs + Op2 * fabs(sum);
...
#[no_mangle]
pub unsafe extern "C" fn cobyla_reason(mut status: libc::c_int) -> *const libc::c_char {
    match status {
        1 => {
        ...
        -1 => {
            return b"rounding errors are becoming damaging\0" as *const u8
                as *const libc::c_char;
        }
        -2 => {
...
unsafe extern "C" fn print_calcfc(
    mut output: *mut FILE,
    mut n: libc::c_long,
    ...
    while i < n {
        fprintf(
            output,
            if i % 5 as libc::c_int as libc::c_long == 0 as libc::c_int as libc::c_long {
                b"\n%19.6E\0" as *const u8 as *const libc::c_char
            } else {
